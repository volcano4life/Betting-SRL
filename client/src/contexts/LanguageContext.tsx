...
const translations: Record<Language, Record<string, string>> = {
  ...
  it: {
    ...
    'admin.transferOwnership': 'Trasferisci Proprietà',
    'admin.transferOwnershipTitle': 'Trasferisci Proprietà del Sito',
    'admin.transferOwnershipDesc': 'Sei sicuro di voler trasferire la proprietà del sito a questo utente? Questo gli darà il pieno controllo sul sito.',
    'admin.transferOwnershipConfirm': 'Sì, Trasferisci Proprietà',
    'admin.transferOwnershipPending': 'Trasferimento in corso',
    'admin.transferOwnershipTimer': 'Trasferimento in {hours}h {minutes}m',
    'admin.cancelTransfer': 'Annulla Trasferimento',
    'admin.transferCancelled': 'Trasferimento di proprietà annullato',
    'admin.transferCompleted': 'Trasferimento di proprietà completato',
